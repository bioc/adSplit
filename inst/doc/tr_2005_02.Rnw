...
%\VignetteDepends{golubEsets, vsn, hu6800}
...
\year{2005}
\abstract{
  This is the vignette of the Bioconductor compliant packege
...
@ 
 ...
 \Rpackage{golubEsets} experimental data package. For normalization we
 use Bioconductor's \Rpackage{vsn} package implementing the variance
 stabilization and calibration method by Huber et
 al. \cite{huber02variance}. For 
...
<<>>=
adSplit(golubNorm, "GO:0006915", "hu6800")
@
...
<<>>=
adSplit(golubNorm, "GO:0007165", "hu6800")
@
...
<<>>=
adSplit(golubNorm, "GO:0007165", "hu6800", max.probes=7000)
@
...
\section{Drawing random gene sets}
 ...
 use a hash containing one entry per EntrezGene (formerly LocusLink, still
 called this in the annotation packages) 
 identifier holding all associated probe-sets. 
 This environment is generated from the
 meta-data package LOCUSID-hash as follows:
...
<<>>=
scores <- randomDiana2means(20, exprs(golubNorm), "hu6800", ndraws = 1000) 
@
...
scores2 <- randomDiana2means(20, exprs(golubNorm), "hu6800", 
...
<<>>=
glutamSplits <- adSplit(golubNorm, "KEGG:00251", "hu6800", B=1000) 
@
